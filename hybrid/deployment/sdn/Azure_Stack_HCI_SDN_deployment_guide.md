...
- **Kubernetes**: Customer deploying AKS on thier Azure Stack HCI cluster may want to use SDN to provide networking to their AKS cluster. With this approach, AKS uses SDN Virtual Networks and Load Balancers for node IPs and ingress/egress--enabling a more dynamic environment. Note, that SDN is not yet supported by AKS on 23H2 as of 5/1/2024.
